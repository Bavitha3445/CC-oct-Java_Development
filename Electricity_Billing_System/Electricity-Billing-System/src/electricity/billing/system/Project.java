...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/pro1.jpg"));
        ...
        user.setForeground(new Color(255,20,147));
        ...
        report.setForeground(new Color(255,20,147));
        ...
        utility.setForeground(new Color(255,20,147)); 
        ...
        mexit.setForeground(new Color(255,20,147));
